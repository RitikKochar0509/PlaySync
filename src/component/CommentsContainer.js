...
const commentsData = [
    {
        name:"Ritik",
        text : "Hi I am Ritik Kochar Building Youtube Clone",
        replies:[
            {
                name:"Ritik",
                text : "Hi I am Ritik Kochar Building Youtube Clone",
